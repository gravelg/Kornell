...
/**
 * translated into java from javascript by Brandon Donnelson Nov 2008 Goal is to
 * be able to use this both on the server and client side easily
 * 
 * TODO Need to test more TODO clean up comments and code
 *
...
public class Sha1 {
     ...
     * 
     * working!!! yippie 11/15/08 working!!! yahoo 11/23/08
     * 
     * @return
     */
     ...
     * @param len
     *            - stick this value at the end of the array, which copies the
     *            javascript function
     * @return
     */
     ...
     * 
     * tested 11/15/08 - works, moving to next, then coming back to do more
     * padding tests tested 11/23/08 - works, padding works, sha signing works.
     * 
     * @param x
     * @param len
     * @return
     ...
     * 
     * I had to modify the unicode and adding to an array. This was a big
     * rewrite for this method
     * 
     * @param str
     * @return
     */
    private int[] str2binb(String str) {
        ...
        for (int i = 0; i < str.length() * chrsz; i += chrsz) {
            ...
            // debug
            // System.out.println("i:" + i + " mask: " + mask + " pos:" + pos +
            // " charUnicode:" + unicode + " cal:" + cal + " bin:" + bin);
        }
        ar.add(bin);
