...
public class AssetsClient extends RESTClient {
    ...
    public void getUploadURL(String entityName, String entityUUID, String filename, String path,
            Callback<String> callback) {
        GET(entityName, entityUUID, "uploadUrl", "?filename=" + filename + "&path=" + path).go(callback);
    }

    public void updateThumbnail(String entityName, String entityUUID, LearningEntity entity, String entityType,
            Callback<LearningEntity> callback) {
        PUT(entityName, entityUUID).withContentType(entityType).withEntityBody(entity).go(callback);
    }

    public void move(String assetType, String entityType, String entityUUID, String direction, Integer index,
            Callback<String> callback) {
