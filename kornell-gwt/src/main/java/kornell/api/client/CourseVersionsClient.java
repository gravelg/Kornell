...
public class CourseVersionsClient extends RESTClient {
	...
	public void findByCourse(String courseUUID, String ps, String pn, String searchTerm, String orderBy, String isAscending, Callback<CourseVersionsTO> callback) {
	...
	public void get(String ps, String pn, String searchTerm, String orderBy, String isAscending, Callback<CourseVersionsTO> callback) {
