...
public class CourseVersionsClient extends RESTClient {
	...
	public void findByCourse(String courseUUID, String ps, String pn, String searchTerm, String orderBy, boolean isAscending, Callback<CourseVersionsTO> callback) {
		GET("/courseVersions" + "?ps=" + ps + "&pn=" + pn + "&searchTerm=" + searchTerm + "&orderBy=" + orderBy + "&asc=" + isAscending +
	...
	public void get(String ps, String pn, String searchTerm, String orderBy, boolean isAscending, Callback<CourseVersionsTO> callback) {
