...
public class CoursesClient extends RESTClient {
    ...
    public void get(boolean fetchChildCourses, String ps, String pn, String searchTerm, String orderBy,
            String isAscending, Callback<CoursesTO> callback) {
        GET("/courses?fetchChildCourses=" + fetchChildCourses + "&ps=" + ps + "&pn=" + pn + "&searchTerm=" + searchTerm
                + "&orderBy=" + orderBy + "&asc=" + isAscending).go(callback);
    }
