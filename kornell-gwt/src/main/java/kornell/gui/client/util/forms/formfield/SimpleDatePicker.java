...
public class SimpleDatePicker extends FlowPanel {
    ...
    private int getMaxDays() {
        ...
        if (dropBoxMonth.getSelectedIndex() <= 0 || month.equals(constants.january()) || month.equals(constants.march())
                || month.equals(constants.may()) || month.equals(constants.july()) || month.equals(constants.august())
    ...
    public boolean isSelected() {
        return dropBoxDay.getSelectedIndex() > 0 && dropBoxMonth.getSelectedIndex() > 0
